...
email = "test.user.05@inbox.ru"
password = "testpassword0505"
stepik_url = "https://stepik.org/catalog"
task_link = "https://stepik.org/lesson/236205/step/7?auth=registration&unit=208637"
answer = "text_to_be_present_in_element"
...
button_login = browser.find_element(By.ID, "ember246").click()
